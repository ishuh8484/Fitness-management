        ...
        RegisterRequest registerRequest = getUserDetails(token);
         ...
         if(userId!=null && token!=null){
             ...
             return userService.validateUser(userId)
                     ...
                     .then(Mono.defer(()->{
                         org.springframework.http.server.reactive.ServerHttpRequest mutatedRequest = (org.springframework.http.server.reactive.ServerHttpRequest) exchange.getRequest().mutate()
